...
// PowerVu Emu
uint8_t PowervuCrc8Calc(uint8_t *data, int len)
{
	int i;
	uint8_t crc = 0x00;
...
void PowervuPadData(uint8_t *data, int len, uint8_t *dataPadded)
{
	int i;
...
void PowervuHashMode01CustomMD5(uint8_t *data, uint8_t *hash)
{
	int i, j, s;
...
void PowervuCreateHash(uint8_t *data, int len, uint8_t *hash, int mode)
{
...
void PowervuCreateDataEcmEmm(uint8_t *emmEcm, uint8_t *pos, int lenHeader, int len, uint8_t *data)
{
	int i;
...
uint8_t PowervuCreateDataCw(uint8_t *seed, uint8_t lenSeed, uint8_t *baseCw, uint8_t val, uint8_t *seedEcmCw, uint8_t *data)
{
	int i;
...
uint8_t PowervuUnmaskEcm(uint8_t *ecm, uint8_t *seedEcmCw)
{
	int i, l;
...
void PowervuCreateCw(uint8_t *seed, uint8_t lenSeed, uint8_t *baseCw, uint8_t val,
...
// PowerVu EMM EMU
void PowervuUnmaskEmm(uint8_t *emm)
{
	int i, l;
